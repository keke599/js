...
const result = scores.reduce((t, v) => t + v.score * v.weight, 1);
...
// 代替some：至少一门合格
const isAtLeastOneQualified = scores1.reduce((t, v) => v.score >= 60, false); // true
console.log(isAtLeastOneQualified);
// 代替every：全部合格
const isAllQualified = scores1.reduce((t, v) => t && v.score >= 60, true); // false
